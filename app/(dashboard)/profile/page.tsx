        ...
        <div className="bg-white dark:bg-[#0c0e16] border border-slate-200 dark:border-white/5 rounded-xl overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex items-start gap-5 flex-wrap mb-6">
              {/* Avatar */}
              <div className="w-20 h-20 shrink-0 rounded-2xl bg-gradient-to-br from-blue-500/15 to-blue-600/25 border border-blue-200 dark:border-blue-500/20 flex items-center justify-center font-mono text-2xl font-bold text-blue-600 dark:text-blue-400">
                {initials}
              </div>
              <div className="flex-1 min-w-0">
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">{fullName}</h2>
                <span className="inline-flex items-center gap-1.5 mt-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-[10px] font-mono font-bold text-blue-600 dark:text-blue-300 uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                },
                {
                  ...
                  label: "Organization",
                  value: user?.client?.name ?? (user as any)?.department?.name ?? (user as any)?.organization ?? "—",
                },
                {
            ...
            {myTickets.length > 0 && (
              <div className="px-4 pb-4">
                <button
                  ...
                  className="w-full py-2 border border-blue-200 dark:border-blue-500/20 bg-blue-50 dark:bg-blue-500/8 text-blue-700 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-500/12 text-xs font-semibold rounded-lg transition flex items-center justify-center gap-1.5"
                >
